							...
							<div class="tab-content">
								<div class="tab-pane row-fluid active" id="tab_1_1">
									<ul class="unstyled profile-nav span3">
										<li><img src="<?php echo base_url();?>uploads/jacksparrow.jpg" height="300" width="300" alt="" /> <a href="#" class="profile-edit">edit</a></li>
										...
										<div class="row-fluid">
											<div class="span8 profile-info">
												...
												<ul class="unstyled inline">
													<li><i class="icon-linkedin"></i><a href="#">John Doe</a> </li>
													<li><i class="icon-twitter"></i><a href="#">@johndoe</a></li>
													<li><i class="icon-google-plus"></i><a href="#"> John Doe </a></li>
													<li><i class="icon-facebook"></i> <a href="#">John Doe </a></li>
													<li><i class="icon-phone"></i><?php echo $info['phone']; ?></li>
												</ul>
												<ul class="unstyled inline">
											...
											<div class="span4">
												<div class="circle">
														<div id="circle-text"><i><h1 style="color:#009ACD;"><b>524 </b></h1><br/><h4>Points</i></h4></div>
												</div>
											</div>
											<!--end span4-->
										</div>
								...
								<div class="tab-pane profile-classic row-fluid" id="tab_1_2">
									<div class="span2"><img src="<?php echo base_url();?>uploads/jacksparrow.jpg" alt="" /> <a href="#" class="profile-edit">edit</a></div>
