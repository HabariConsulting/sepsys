...
class Ion_auth_model extends CI_Model
{
	...
	**/
	...
	function data_info($identity){
		return mysql_fetch_assoc(mysql_query("SELECT * FROM `users` where email='$identity'"));
		//return mysql_fetch_assoc(mysql_query("SELECT * FROM `users` u INNER JOIN `user_groups` ug ON u.`id`=ug.`user_id` INNER JOIN `groups` g ON ug.`group_id`=g.`id` where u.`email`='$identity'"));
		}
