<?php
	...
	?> <h3><?php echo anchor('posts/create','Create New Post'); ?> </h3> <?php
			...
			<td>
				<?php 
					$Css_class = array('class' => 'btn mini blue-stripe');
					 echo anchor('posts/edit/'.$product->id, 'Edit', $Css_class);								
				?>

				<?php 
					$Css_class = array('class' => 'btn mini green-stripe');
					 echo anchor('posts/publish_post/'.$product->id, 'Publish', $Css_class);								
				?>		
				
				<?php 
					$Css_class = array('class' => 'btn mini red-stripe');
					 echo anchor('posts/unpublish_post/'.$product->id, 'Unpublish', $Css_class);								
				?>
